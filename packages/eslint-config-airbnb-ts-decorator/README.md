...
Add typescript support to Airbnb's ESLint config's. This library should typically not be used. Instead use [eslint-config-airbnb-ts](../eslint-config-airbnb-ts/README.md) or [eslint-config-airbnb-ts-base](../eslint-config-airbnb-base-ts/README.md)
